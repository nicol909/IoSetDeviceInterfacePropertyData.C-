// IoSetDeviceInterfacePropertyData.C++.cpp : Ce fichier contient la fonction 'main'. L'exécution du programme commence et se termine à cet endroit.
//

#include "pch.h"
#include "framework.h"
#include "IoSetDeviceInterfacePropertyData.C++.h"
